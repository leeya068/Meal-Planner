...
public class MealScheduler {
    ...
    public MealScheduler() {
        ...
        meals.add(new Meal("SNACK", "SNK", 0, 4));  // Early morning snack
        meals.add(new Meal("SNACK", "SNK", 22, 23)); // Late night snack
    }
    ...
    public Meal getMealByHour(int hour) {
        // Using switch expression with ranges for demonstration
        return switch (hour) {
